		...
		<div id="tab-system" class="HuiTab">
			...
			<div class="tabCon">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <label><input type="radio" name="info[agent_commission_open]" value="1" <?php if($setlist['agent_commission_open'] == 1): ?>checked<?php endif; ?>>是 </label>&nbsp;&nbsp;
                        <label><input type="radio" name="info[agent_commission_open]" value="0" <?php if($setlist['agent_commission_open'] == 0): ?>checked<?php endif; ?>>否 </label>
                    </div>
                </div>
				<!--<div class="row cl">
...
每充值<input type="text" name="info[pointchongzhi]" class="input-text" value="<?php echo ($setlist["pointchongzhi"]); ?>" style="width:60px;">元&nbsp;积分增加<input type="text" name="info[pointchongzhiadd]" class="input-text" value="<?php echo ($setlist["pointchongzhiadd"]); ?>" style="width:60px;">分
			...
			<div class="tabCon">
                ...
                <div class="row cl">
                    <?php
 $countries = array( array( 'code'=>'PH', 'name'=>'菲律宾' ), array( 'code'=>'MY', 'name'=>'马来西亚' ), array( 'code'=>'KH', 'name'=>'柬埔寨' ), array( 'code'=>'LA', 'name'=>'老挝' ), array( 'code'=>'JP', 'name'=>'日本' ), array( 'code'=>'KP', 'name'=>'韩国' ), array( 'code'=>'VN', 'name'=>'越南' ), array( 'code'=>'CN', 'name'=>'中国' ), ); $banCountry = $setlist['bancountry'] ? json_decode($setlist['bancountry']) : array(); ?>
                    ...
                    <div class="cplist" style="padding:10px 15px; height:1%; overflow:hidden">
                        <?php if(is_array($countries)): $i = 0; $__LIST__ = $countries;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="formControls col-xs-6 col-sm-4 col-md-2 skin-minimal radio-box">
                            <input name="info[bancountry][]" type="checkbox" value="<?php echo ($v["code"]); ?>" <?php if( in_array($v['code'],$banCountry) ) echo 'checked' ;?>><?php echo ($v["name"]); ?>
