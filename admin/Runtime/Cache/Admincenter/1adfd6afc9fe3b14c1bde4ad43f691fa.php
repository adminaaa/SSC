...
<aside class="Hui-aside">
    ...
    <dd style="display:block">
        <ul>
            ...
            <li><a href="<?php echo U('Caipiao/oldWanfa');?>" data-title="传统玩法管理">传统玩法管理</a></li>
...
<dl id="menu-article">
    ...
    <dd>
        <ul>
            ...
            <li><a href="<?php echo U('Zhenren/sstzrecord');?>" data-title="KY投注记录">KY投注记录</a></li>
            ...
            <li><a href="<?php echo U('Zhenren/sstzreport');?>" data-title="KY会员报表">KY会员报表</a></li>
...
<dl id="menu-article">
    ...
    <dd>
        <ul>
            ...
            <li><a href="<?php echo U('Member/fanshui');?>" data-title="会员反水">会员反水</a></li>
