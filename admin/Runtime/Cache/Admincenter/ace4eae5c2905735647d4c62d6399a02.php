...
<div class="page-container">
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_rixiaofei_shi]">
                    <?php $__FOR_START_10506__=0;$__FOR_END_10506__=24;for($i=$__FOR_START_10506__;$i < $__FOR_END_10506__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_rixiaofei_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_rixiaofei_fen]">
                    <?php $__FOR_START_19376__=1;$__FOR_END_19376__=60;for($i=$__FOR_START_19376__;$i < $__FOR_END_19376__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_rixiaofei_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_rikuisun_shi]">
                    <?php $__FOR_START_21371__=0;$__FOR_END_21371__=24;for($i=$__FOR_START_21371__;$i < $__FOR_END_21371__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_rikuisun_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_rikuisun_fen]">
                    <?php $__FOR_START_26455__=1;$__FOR_END_26455__=60;for($i=$__FOR_START_26455__;$i < $__FOR_END_26455__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_rikuisun_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
                <td>赠送前一天(系统设置->赠送活动)</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_yuexiaofei_shi]">
                    <?php $__FOR_START_31422__=0;$__FOR_END_31422__=24;for($i=$__FOR_START_31422__;$i < $__FOR_END_31422__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_yuexiaofei_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_yuexiaofei_fen]">
                    <?php $__FOR_START_8583__=1;$__FOR_END_8583__=60;for($i=$__FOR_START_8583__;$i < $__FOR_END_8583__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_yuexiaofei_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_yuekuisun_shi]">
                    <?php $__FOR_START_24670__=0;$__FOR_END_24670__=24;for($i=$__FOR_START_24670__;$i < $__FOR_END_24670__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_yuekuisun_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_yuekuisun_fen]">
                    <?php $__FOR_START_18359__=1;$__FOR_END_18359__=60;for($i=$__FOR_START_18359__;$i < $__FOR_END_18359__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_yuekuisun_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
                <td>赠送上一个月(系统设置->赠送活动)</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_dailifandian_shi]">
                    <?php $__FOR_START_11714__=0;$__FOR_END_11714__=24;for($i=$__FOR_START_11714__;$i < $__FOR_END_11714__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_dailifandian_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_dailifandian_fen]">
                    <?php $__FOR_START_20559__=1;$__FOR_END_20559__=60;for($i=$__FOR_START_20559__;$i < $__FOR_END_20559__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_dailifandian_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
            ...
            <tr class="text-c">
                ...
                <td>
                    ...
                    <select class="select" name="jihua[jihua_dbautoback_shi]">
                        <?php $__FOR_START_12233__=0;$__FOR_END_12233__=8;for($i=$__FOR_START_12233__;$i < $__FOR_END_12233__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_dbautoback_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                    </select>
                    </span>-->
                    ...
                    <select class="select" name="jihua[jihua_dbautoback_fen]">
                        <?php $__FOR_START_11368__=10;$__FOR_END_11368__=121;for($i=$__FOR_START_11368__;$i < $__FOR_END_11368__;$i+=5){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_dbautoback_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分钟</option><?php } ?>
                    </select>
                    </span>-->
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_kaijiang_days]">
                    <?php $__FOR_START_21527__=1;$__FOR_END_21527__=61;for($i=$__FOR_START_21527__;$i < $__FOR_END_21527__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_kaijiang_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留1天的开奖</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_touzhu_days]">
                    <?php $__FOR_START_30806__=45;$__FOR_END_30806__=91;for($i=$__FOR_START_30806__;$i < $__FOR_END_30806__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_touzhu_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留45天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_fandian_days]">
                    <?php $__FOR_START_7656__=1;$__FOR_END_7656__=61;for($i=$__FOR_START_7656__;$i < $__FOR_END_7656__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_fandian_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留1天</td>
  ...
  <!--          <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_jinjijiangli_days]">
                    <?php $__FOR_START_2487__=1;$__FOR_END_2487__=61;for($i=$__FOR_START_2487__;$i < $__FOR_END_2487__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_jinjijiangli_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留1天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_fanshui_days]">
                    <?php $__FOR_START_13928__=1;$__FOR_END_13928__=61;for($i=$__FOR_START_13928__;$i < $__FOR_END_13928__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_fanshui_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留1天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_fuddetail_days]">
                    <?php $__FOR_START_3815__=45;$__FOR_END_3815__=91;for($i=$__FOR_START_3815__;$i < $__FOR_END_3815__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_fuddetail_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留45天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_memlog_days]">
                    <?php $__FOR_START_7395__=7;$__FOR_END_7395__=31;for($i=$__FOR_START_7395__;$i < $__FOR_END_7395__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_memlog_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留7天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_adminlog_days]">
                    <?php $__FOR_START_21243__=7;$__FOR_END_21243__=31;for($i=$__FOR_START_21243__;$i < $__FOR_END_21243__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_adminlog_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留7天</td>
