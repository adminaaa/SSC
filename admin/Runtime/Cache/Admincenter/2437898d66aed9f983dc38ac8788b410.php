	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td><?php echo ($vo["kyID"]); ?></td>
               
                <td><?php echo ($vo["account_code"]); ?></u></td>
                 <td><?php echo ($vo["transactionid"]); ?></td>
                <td><?php echo ($vo["play_type"]); ?></td>
                <td><?php echo ($vo["league_name"]); ?> <?php echo ($vo["teamA_name"]); ?>VS<?php echo ($vo["teamB_name"]); ?></td>
			
				<td><?php echo ($vo["bet_type_code"]); ?>/<?php echo ($vo["Team_bet_code"]); ?>@<?php echo ($vo["wager_odds"]); ?></td>
                <td><?php echo ($vo["wager_stake"]); ?></td>
				   <td><?php echo ($vo["win_amt"]); ?></td>
             
				<td><?php echo ($vo["date_created"]); ?></td>
