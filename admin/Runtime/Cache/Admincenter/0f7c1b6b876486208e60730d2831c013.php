	...
	<form action="" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="is_old" type="radio" id="isold-1" value="1" <?php if($info[is_old] == 1): ?>checked<?php endif; ?>>
					<label for="isold-1">是</label>
				</div>
				<div class="radio-box">
					<input type="radio" name="is_old" id="isold-0" value="0" <?php if($info[is_old] == 0): ?>checked<?php endif; ?>>
