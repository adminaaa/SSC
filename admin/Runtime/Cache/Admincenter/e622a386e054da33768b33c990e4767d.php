...
<span class="l">
<?php if(isset($parentid)): ?><a href="javascript:;" layer-url="<?php echo U('useradd',['parentid'=>$parentid]);?>" title="添加会员" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加会员</a>&nbsp;&nbsp;&nbsp;
<?php else: ?>
<a href="javascript:;" layer-url="<?php echo U('useradd');?>" title="添加会员" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加会员</a>&nbsp;&nbsp;&nbsp;<?php endif; ?>
