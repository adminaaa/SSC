...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>传统玩法：</label>
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="is_old" type="radio" id="isold-1" value="1" {if condition="$info[is_old] eq 1"}checked{/if}>
					<label for="isold-1">是</label>
				</div>
				<div class="radio-box">
					<input type="radio" name="is_old" id="isold-0" value="0" {if condition="$info[is_old] eq 0"}checked{/if}>
					<label for="isold-0">否</label>
				</div>
			</div>
		</div>
