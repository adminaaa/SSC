...
{/volist}
        ...
        {present name="parentInfo"}

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>上级：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{$parentInfo.username}" disabled>
                <input  class="input-text" value="{$parentInfo.id}" name="parentid" type="hidden">
            </div>
        </div>
        {/present}
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="最大返点{$parentInfo.fandian}%" name="fandian">
            </div>
        </div>
        {else /}
		<div class="row cl">
