...
<!--footer end------------->
<div class="kefu onk" style="width:140px; height:95px;position:absolute"><img style="cursor:pointer;" onclick="lianxikefu();" src="https://www16.53kf.com/img/upload/10139365/zdypic/icon_off_101393651472576593.png" width="140" height="95" />
<?php $kefuqq = C('kefuqq');?>
{if condition="is_numeric($kefuqq) and ($kefuqq neq '')"}
<p style="margin-top:10px;text-align:center; font-weight:bold;"><a href="https://wpa.qq.com/msgrd?v=3&uin={$kefuqq}&site=qq&menu=yes" target="_blank" style="color:#d62d2d">客服QQ：{$kefuqq}</a></p>
{/if}
</div>
