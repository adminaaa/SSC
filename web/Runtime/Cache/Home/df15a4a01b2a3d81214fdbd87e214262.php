				...
				<form  method="post" action="/hxpay/pay.php" onSubmit="return checkform(this)">
					<div class="common_border_box1 choiceBank_box">
						<div class="choiceMoney">
							...
							<input type="text" name="amount" id="amount" placeholder="最低充值<?php echo ($payinfo["minmoney"]); ?>" class="common_input">
						</div>
						...
						<div class="prompt">
							<p>※ 温馨提示：</p>
							<p>单笔充值金额最低<?php echo ($payinfo["minmoney"]); ?>元，最<?php echo ($payinfo["maxmoney"]); ?>高元。</p>
