						...
						<div id="pay_alipay" class="me-infor" style="display:none;">
							<div class="infor-xx">
								...
								<div>
									...
									<a class="btn common_btn" style="width:10em;display:block;margin:1em auto;" href="javascript:;" onclick="alt('充值申请已成功提交'); window.location.href = '<?php echo U('Account/dealRecord2');?>'">扫码完成支付</a>
								</div>
							</div>
						</div>
						<div class="prompt">
