            ...
            <div class="least_luckMember">
                ...
                <ul class="ranking_list sum_icon ranking_scroll">
                   ...
                   <div class=&quot;media-footer&quot; style=&quot;padding-top:3px;&quot;>
                       <?php if(is_array($value['k3names'])): $i = 0; $__LIST__ = array_slice($value['k3names'],0,12,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><a href=&quot;<?php echo U('Game/k3');?>?code=<?php echo ($val[name]); ?>&quot; class=&quot;color_res&quot; ><span style=&quot;color:#333&quot;><?php echo (substr($val["title"],0,6)); ?></span><i class=&quot;iconfont&quot;></i></a><?php endforeach; endif; else: echo "" ;endif; ?>
