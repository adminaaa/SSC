...
<body>
	...
	<div class="activity_list">
		<a href="<?php echo U('Activity/s2');?>" class="am-cf am-block">
	...
	<div class="activity_list">
		<a href="<?php echo U('Activity/show');?>?id=6" class="am-cf am-block">
	...
	<div class="activity_list">
		<a href="<?php echo U('Activity/show');?>?id=7" class="am-cf am-block">
